# Level 4: Pseudocode to Typescript
...
You're progressing! Now you'll take more complex pseudocode and translate it into Typescript code. This level focuses on taking user input.
...
```bash
cd ~/.local/share/learn/workspaces/typescript/stage-2/level-4
```
