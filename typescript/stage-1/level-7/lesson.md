...
- Understand how to use functions in Typescript
...
We'll focus on understanding how functions works in Typescript. For now, copy the provided code and run it to see the results. Don't worry if you don't understand every detail yet - that comes with practice!
