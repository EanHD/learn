# Level 4: Pseudocode to Powershell
## Stage 2: Pseudocode to Code

### Today's Mission

You're progressing! Now you'll take more complex pseudocode and translate it into Powershell code. This level focuses on taking user input.
...
```bash
cd ~/.local/share/learn/workspaces/powershell/stage-2/level-4
```
