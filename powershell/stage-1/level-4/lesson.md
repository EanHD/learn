...
- Understand how to use user input in Powershell
...
We'll focus on understanding how user input works in Powershell. For now, copy the provided code and run it to see the results. Don't worry if you don't understand every detail yet - that comes with practice!
