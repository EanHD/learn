...
Now that you know the basics, it's time to think like a programmer! You'll take pseudocode (plain English instructions) and translate it into real Csharp code. This is where programming logic comes to life.

### Learning Goals

- Understand how pseudocode maps to real code
- Learn to translate plain English into Csharp syntax
...
- Each `print` instruction becomes the appropriate output statement in Csharp
