# Level 2: Intermediate Integration Project
...
## Stage 5: Capstone - Multi-Feature Application

### Today's Mission

You've completed your first capstone. Now build something more ambitious with **multiple integrated features** working together seamlessly.

This project should demonstrate your ability to design and implement a cohesive system with multiple components that interact with each other.
...
Your Level 2 Capstone should:

**Complexity**: Intermediate (5-7 main features)
**Code Size**: 500-800 lines
...
Choose a project that requires multiple features to work together:

**Example Projects:**

**1. Library Management System**
- Book catalog with multiple copies
- Member management
