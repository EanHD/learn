...
Welcome to your first R program! Today, you'll create and run your very first program.

---

### Learning Goals

- Understand the basic structure of a R program
- Learn how to compile/run R code
...
- This is the basic structure all R programs follow
