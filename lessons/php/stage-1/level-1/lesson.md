...
Welcome to your first PHP program! Today, you'll create and run your very first program.

---

### Learning Goals

- Understand the basic structure of a PHP program
- Learn how to compile/run PHP code
...
- This is the basic structure all PHP programs follow
