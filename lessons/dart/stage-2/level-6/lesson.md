...
You're progressing! Now you'll take more complex pseudocode and translate it into Dart code. This level focuses on using loops for repetition.
...
```
cd ~/.local/share/learn/workspaces/dart/stage-2/level-6
```
