...
You're progressing! Now you'll take more complex pseudocode and translate it into Dart code. This level focuses on making decisions with conditionals.
...
```bash
cd ~/.local/share/learn/workspaces/dart/stage-2/level-5
```dart
...
3. Implement each step in Dart, one at a time
4. Test as you go
