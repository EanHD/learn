...
- Understand how to use conditionals in Shell
...
We'll focus on understanding how conditionals works in Shell. For now, copy the provided code and run it to see the results. Don't worry if you don't understand every detail yet - that comes with practice!
