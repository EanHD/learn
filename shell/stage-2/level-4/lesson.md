...
You're progressing! Now you'll take more complex pseudocode and translate it into Shell code. This level focuses on taking user input.
...
```bash
cd ~/.local/share/learn/workspaces/shell/stage-2/level-4
```
