...
Now that you know the basics, it's time to think like a programmer! You'll take pseudocode (plain English instructions) and translate it into real Kotlin code. This is where programming logic comes to life.

### Learning Goals

- Understand how pseudocode maps to real code
- Learn to translate plain English into Kotlin syntax
...
**Your mission**: Translate this pseudocode into Kotlin code and save it as `main.kt`.

Hints:

- Each `print` instruction becomes the appropriate output statement in Kotlin
...
```bash
cd ~/.local/share/learn/workspaces/kotlin/stage-2/level-1
kotlinc main.kt
```
...
- [ ] Created three output statements
- [ ] Each output statement has the correct message
