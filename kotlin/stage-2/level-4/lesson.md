...
You're progressing! Now you'll take more complex pseudocode and translate it into Kotlin code. This level focuses on taking user input.
...
```bash
cd ~/.local/share/learn/workspaces/kotlin/stage-2/level-4
```
