...
Now that you know how to run Kotlin programs, let's learn about variables! Variables are like containers that store information. Kotlin makes it easy to work with different data types.

### Learning Goals

- Understand what variables are and why they're useful
- Learn about Kotlin's data types
- Practice storing and displaying different types of data
- See how variables make code reusable

### Your Task

Copy the following code EXACTLY as shown into a new file called `variables.kt`:
...
- [ ] Created a file named `variables.kt`
