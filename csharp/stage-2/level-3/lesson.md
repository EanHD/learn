...
You're progressing! Now you'll take more complex pseudocode and translate it into Csharp code. This level focuses on performing calculations.
...
```bash
cd ~/.local/share/learn/workspaces/csharp/stage-2/level-3
```
