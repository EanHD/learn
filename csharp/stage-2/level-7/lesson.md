# Level 7: Pseudocode to Csharp
## Stage 2: Pseudocode to Code

### Today's Mission

You're progressing! Now you'll take more complex pseudocode and translate it into Csharp code. This level focuses on writing and calling functions.
...
```bash
cd ~/.local/share/learn/workspaces/csharp/stage-2/level-7
```
