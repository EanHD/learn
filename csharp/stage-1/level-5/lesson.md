...
- Understand how to use conditionals in Csharp
- Learn the syntax specific to Csharp
- Practice implementing conditionals
- See real-world use cases

### Your Task

We'll focus on understanding how conditionals works in Csharp. For now, copy the provided code and run it to see the results. Don't worry if you don't understand every detail yet - that comes with practice!
