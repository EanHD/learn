...
Now that you've learned the basics, let's explore if/else statements and decision making! This fundamental concept is used in almost every program you'll write.

### Learning Goals

- Understand how to use conditionals in Swift
- Learn the syntax specific to Swift
- Practice implementing conditionals
- See real-world use cases

### Your Task

We'll focus on understanding how conditionals works in Swift. For now, copy the provided code and run it to see the results. Don't worry if you don't understand every detail yet - that comes with practice!
