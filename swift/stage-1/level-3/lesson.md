...
- Understand how to use basic math in Swift
...
We'll focus on understanding how basic math works in Swift. For now, copy the provided code and run it to see the results. Don't worry if you don't understand every detail yet - that comes with practice!
