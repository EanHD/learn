...
- Understand how to use loops in Swift
...
We'll focus on understanding how loops works in Swift. For now, copy the provided code and run it to see the results. Don't worry if you don't understand every detail yet - that comes with practice!
