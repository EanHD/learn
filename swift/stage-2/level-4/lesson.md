# Level 4: Pseudocode to Swift
## Stage 2: Pseudocode to Code

### Today's Mission

You're progressing! Now you'll take more complex pseudocode and translate it into Swift code. This level focuses on taking user input.
...
```bash
cd ~/.local/share/learn/workspaces/swift/stage-2/level-4
```
