...
- Understand how to use user input in Dart
...
We'll focus on understanding how user input works in Dart. For now, copy the provided code and run it to see the results. Don't worry if you don't understand every detail yet - that comes with practice!
