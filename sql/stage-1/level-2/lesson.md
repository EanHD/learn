...
Now that you know how to run Sql programs, let's learn about variables! Variables are like containers that store information. Sql makes it easy to work with different data types.

### Learning Goals

- Understand what variables are and why they're useful
- Learn about Sql's data types
...
- [ ] Created a file named `variables.sql`
