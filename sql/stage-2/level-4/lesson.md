...
You're progressing! Now you'll take more complex pseudocode and translate it into Sql code. This level focuses on taking user input.
...
```bash
cd ~/.local/share/learn/workspaces/sql/stage-2/level-4
```
